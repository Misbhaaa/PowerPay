...
public class Project extends JFrame implements ActionListener {
    ...
    Project(String atype, String meter) {
        ...
        // Adding Delete Customer menu item
        ...
        ImageIcon iconDelete = new ImageIcon(ClassLoader.getSystemResource("icon/icon4.png"));
        Image imageDelete = iconDelete.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        deletecustomer.setIcon(new ImageIcon(imageDelete));
        ...
        generatereceipt.setFont(new Font("monospaced", Font.PLAIN, 12));
        generatereceipt.setBackground(Color.WHITE);
        ImageIcon iconReceipt = new ImageIcon(ClassLoader.getSystemResource("icon/icon8.png"));
        Image imageReceipt = iconReceipt.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        generatereceipt.setIcon(new ImageIcon(imageReceipt));
        generatereceipt.setMnemonic('G');
        generatereceipt.addActionListener(this);
        generatereceipt.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_G, ActionEvent.CTRL_MASK));
        report.add(generatereceipt);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        else if (msg.equals("Generate Receipt")) {
            new Receipt(meter);
        }
    }
