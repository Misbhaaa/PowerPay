        ...
        if (ae.getSource() == create) {
            ...
            try {
                ...
                if (atype.equals("Admin")) {
                    ...
                    ResultSet rs = c.s.executeQuery("SELECT COUNT(*) AS adminCount FROM login WHERE user = 'Admin'");
                    if (rs.next()) {
                        int adminCount = rs.getInt("adminCount");
                        if (adminCount > 0) {
                            JOptionPane.showMessageDialog(null, "An admin already exists. You can't sign up as an admin.");
